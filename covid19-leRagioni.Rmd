...
```{r traduzione per cosmetica, echo = FALSE}
translate = c("nuovi casi", "nuove morti", "nuove vaccinazioni", "continente", "paese", "popolazione", 
              "densità abitativa", "età media", "over 65", "over 70", "PIL p.c.", "povertà estrema",
              "tasso morti cardiovascolari", "prevalenza diabete", "fumatrici", "fumatori", "posti letto",
              "aspettativa di vita", "indice sviluppo umano", "indice contenimento")
```
